...
export default function RegisterPage() {
  ...
  const errors = useMemo(() => {
    ...
    else if (!hasUpper(form.password)) next.password = 'Password must include at least 1 uppercase letter.'
    else if (!hasNumber(form.password)) next.password = 'Password must include at least 1 number.'
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-8">
      <div className="w-full max-w-md animate-slide-up">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-slate-600">Set up your account to start managing issues.</p>
        </div>
        ...
        <div className="surface p-6 sm:p-7">
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div>
              ...
              />
              {touched.name && errors.name && <p className="mt-1 text-xs font-medium text-red-600">{errors.name}</p>}
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">Use at least 8 characters with 1 uppercase letter and 1 number.</p>
            </div>
            ...
            <div>
              ...
              />
              {touched.confirm && errors.confirm && <p className="mt-1 text-xs font-medium text-red-600">{errors.confirm}</p>}
            </div>
